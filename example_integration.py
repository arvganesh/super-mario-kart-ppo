...
def main():
    ...
    # Create environment
    env = retro.make(INTEGRATION_NAME, inttype=retro.data.Integrations.ALL, use_restricted_actions=retro.Actions.DISCRETE) # INTEGRATION_NAME should match a folder name within NEW_INTEGRATIONS_DIR
